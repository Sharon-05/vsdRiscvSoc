...
|----------------------|------------|---------|----------|----------|-----------|--------|----------|-------------------------------------------|-------------------------------------------------|
| `addi sp,sp,-32`     | 0x1101     | 0010011 | x2 (sp)  | x2 (sp)  | -32       | 000    | N/A      | 111111111000 00010 000 00010 0010011       | sp = sp + (-32)                                 |
| `sd ra,24(sp)`       | 0xec06     | 0100011 | N/A      | x2 (sp)  | x1 (ra)   | 011    | N/A      | 0000000 00001 00010 011 11000 0100011      | mem[sp+24] = ra                                 |
| `sd s0,16(sp)`       | 0xe822     | 0100011 | N/A      | x2 (sp)  | x8 (s0)   | 011    | N/A      | 0000000 01000 00010 011 10000 0100011      | mem[sp+16] = s0                                 |
| `addi s0,sp,32`      | 0x1000     | 0010011 | x8 (s0)  | x2 (sp)  | 32        | 000    | N/A      | 000000001000 00010 000 01000 0010011       | s0 = sp + 32                                    |
| `lui a5,0x1c`        | 0x67f1     | 0110111 | x15 (a5) | N/A      | 0x1c000   | N/A    | N/A      | 0000000000011100 01111 0110111             | a5 = 0x1c << 12                                 |
